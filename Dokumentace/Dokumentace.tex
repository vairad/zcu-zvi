...
V další fázi se budou detekovat inkluze. Metody detekce.
...
Aplikace je psána v jazyce C++ s~použitím knihovny pro zpracování obrazu OpenCV verze 2.4, která je snadno dostupná na všech platformách, a knihovny Qt pro vytvoření grafického uživatelského rozhraní.
	Program je rozdělen do několika modulů, moduly implementující grafické uživatelské rozhraní jsou ve složce \texttt{gui} a moduly pro zpracování snímků ve složce \texttt{core}. Cleaner - vtvoří šedotón, 
